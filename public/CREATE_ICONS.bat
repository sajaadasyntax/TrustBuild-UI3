...
echo 2. Upload: project/public/logo.svg
...
echo    magick logo.svg -resize 192x192 icon-192.png
echo    magick logo.svg -resize 512x512 icon-512.png
echo    magick logo.svg -resize 72x72 -colorspace Gray badge-72.png
echo.
