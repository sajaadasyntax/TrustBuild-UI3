...
export default function ClientInvoiceDetailPage() {
  ...
  const fetchInvoiceDetails = async (invoiceId: string) => {
    try {
      setLoading(true)
      const data = await customersApi.getInvoiceById(invoiceId)
      setInvoice(data)
    } catch (error) {
      toast({
        title: "Error",
    ...
    <div className="container py-10 space-y-6">
      ...
      {loading ? (
            ...
            <CardContent className="space-y-6">
              ...
              <div>
                ...
                <p className="text-muted-foreground text-sm">
                  This invoice was generated automatically and is related to your payments on TrustBuild.
                  {invoice.paidAt 
        ...
        <Card>
          ...
          <CardContent>
            <Button variant="outline" onClick={() => router.push('/dashboard/client/invoices')}>
